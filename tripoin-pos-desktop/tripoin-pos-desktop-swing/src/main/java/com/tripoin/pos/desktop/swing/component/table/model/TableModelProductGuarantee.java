 ...
 */
@Component
public class TableModelProductGuarantee extends AScaffoldingTableModel<ProductGuaranteeResponseDTO> {
    /**
     *
     *
     */
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex){
            ...
            case 3 : return dataList.get(rowIndex).getMerchantGuarantee();
            case 4 : return dataList.get(rowIndex).getBrandGuarantee();
