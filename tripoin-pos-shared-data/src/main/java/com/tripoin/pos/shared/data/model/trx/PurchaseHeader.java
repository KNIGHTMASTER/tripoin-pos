 ...
 */
@Entity
@Table(name = "trx_purchase_header")
public class PurchaseHeader extends AAuditTrail {
    /**
     *
     *
     */
    private static final long serialVersionUID = -1423918336107061695L;
